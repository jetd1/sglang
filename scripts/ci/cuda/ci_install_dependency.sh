...
# PyTorch 2.11.0 PyPI wheels default to CUDA 13.0. When installing with --extra-index-url
# for cu129, torch may bundle a different CUDA than torchaudio/torchvision.
...
# We reinstall torchaudio/torchvision from an index matching torch's CUDA version.
