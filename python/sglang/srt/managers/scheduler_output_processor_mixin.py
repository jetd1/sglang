...
class SchedulerOutputProcessorMixin:
    ...
    def _maybe_update_reasoning_tokens(
        ...
        think_end_token_ids = self.model_config.think_end_token_ids or (
            [[self.model_config.think_end_id]]
            if self.model_config.think_end_id is not None
            else None
        )
        if req.require_reasoning and think_end_token_ids is not None:
            req.update_reasoning_tokens(next_token_id, think_end_token_ids)
